...
const Hero = () => {
  ...
  // Animation variants (keeping only container and image variants)
  ...
  return (
    <div className="min-h-screen bg-[#1c2636] overflow-x-hidden">
      {/* Hero Content */}
      <div className="relative overflow-x-hidden">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 md:px-8 lg:px-20 pt-6 sm:pt-8 md:pt-10 overflow-x-hidden">
          <motion.div
            className="grid lg:grid-cols-2 items-center gap-6 sm:gap-8 lg:gap-12 overflow-x-hidden"
          ...
          >
            {/* Left Content */}
            <motion.div
              className="space-y-6 lg:space-y-8 lg:pr-8 order-2 lg:order-1 text-center lg:text-left overflow-x-hidden"
              variants={leftContentVariants}
            >
              <div className="space-y-6 lg:space-y-8">
                {/* Badge - removed animation variants */}
                ...
                {/* Title - removed animation variants, kept underline animation */}
                <h1 className="uppercase text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight sm:leading-normal text-white">
                  Building Wealth{" "}
                ...
                {/* Description - removed animation variants */}
              ...
              {/* Buttons - removed text animation variants, kept hover effects */}
